            ...
            <div className="ml-4 text-sm text-neutral-400">
              <ul className="list-disc">
                ...
                <li>
                  ...
                  time to half on large projects, and increase FPS when entities
                  are moved offscreen.
                </li>
                <li>
                ...
                <li>
                  ...
                  browser on every 5 edits or 10 seconds after last edit. If you
                  closed the editor without saving, don&apos;t worry -
